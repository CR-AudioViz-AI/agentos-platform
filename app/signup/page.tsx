...
type UserRole = 'customer' | 'agent' | 'broker';
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        if (formData.role === 'agent' || formData.role === 'broker') {
          ...
          if (agentError) {
            console.error('Agent entry creation error:', agentError);
          }

          setMessage(
            'Account created! Please check your email to verify your account. An admin will review your agent application.'
          );
        } else {
          setMessage(
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-2xl">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Join AgentOS and find your dream property
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
              >
                <option value="customer">Home Buyer/Seller</option>
                <option value="agent">Real Estate Agent</option>
                <option value="broker">Broker</option>
              </select>
              {(formData.role === 'agent' || formData.role === 'broker') && (
